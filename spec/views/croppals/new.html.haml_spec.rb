...
describe "croppals/new.html.haml" do
  before(:each) do
    assign(:croppal, stub_model(Croppal,
      :user => nil,
      :masterpiece => nil,
      :type => "MyString",
      :cx => "MyString",
  ...
  it "renders new croppal form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => croppals_path, :method => "post" do
